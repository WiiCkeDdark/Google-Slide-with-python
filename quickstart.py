...
# sur ce lien tu as toute les autorisations possible : https://developers.google.com/identity/protocols/oauth2/scopes#slides
SCOPES = ['hhttps://www.googleapis.com/auth/drive']

# The ID of a sample presentation.
# ID que tu trouves dans la bar de recherche quand tu as un slide ouvert entre /d/ et /edit
# ça doit ressembler a un truc comme ça : https://docs.google.com/presentation/d/{presentationID}/edit

PRESENTATION_ID = '1P2ZKJf6YubIeItelKwfZbEL3iUS8vu98EvhNd2LFqdk'


# -> Je te conseil de toujours utiliser ce bout de code pour récupérer les identifiants ça permet si tu as un problème de les régénérer :
# creds = None
...
def Example(presentation_id):
    ...
    if not creds or not creds.valid:
        ...
        # sauvegarde pour ne pas a chaque fois refaire la manip sur le navigateur
        with open('token.json', 'w') as token:
            token.write(creds.to_json())
...
# Si tu veux plus d'exemple sur la manipulation de slide je te conseil ce lien : https://developers.google.com/slides/api/guides/presentations
